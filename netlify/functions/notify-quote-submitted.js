...
// Sends Robbie an internal email when a client submits a quote
...
export default async (req) => {
  ...
  const itemsSummary = (items || []).map((it, i) => `
    <tr style="border-bottom:1px solid rgba(246,243,238,0.08);">
      ...
      <td style="padding:10px 12px;font-size:13px;">
        ${it.url ? `<a href="${it.url}" style="color:#c99a5f;font-size:12px;">View ↗</a>` : '—'}
      </td>
    </tr>`).join('');
        ...
        <tr><td style="padding:24px 36px 0;">
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid rgba(246,243,238,0.1);border-radius:8px;overflow:hidden;">
            <tr style="background:rgba(246,243,238,0.05);">
              <th style="padding:10px 12px;font-size:10px;letter-spacing:0.12em;text-transform:uppercase;color:#c99a5f;text-align:left;font-weight:600;">#</th>
              <th style="padding:10px 12px;font-size:10px;letter-spacing:0.12em;text-transform:uppercase;color:#c99a5f;text-align:left;font-weight:600;">Item</th>
              <th style="padding:10px 12px;font-size:10px;letter-spacing:0.12em;text-transform:uppercase;color:#c99a5f;text-align:left;font-weight:600;">Qty</th>
              <th style="padding:10px 12px;font-size:10px;letter-spacing:0.12em;text-transform:uppercase;color:#c99a5f;text-align:left;font-weight:600;">Type</th>
              <th style="padding:10px 12px;font-size:10px;letter-spacing:0.12em;text-transform:uppercase;color:#c99a5f;text-align:left;font-weight:600;">Notes</th>
              <th style="padding:10px 12px;font-size:10px;letter-spacing:0.12em;text-transform:uppercase;color:#c99a5f;text-align:left;font-weight:600;">Link</th>
            </tr>
            ${itemsSummary}
          </table>
        </td></tr>
