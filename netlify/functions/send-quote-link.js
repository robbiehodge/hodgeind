        ...
        <tr><td style="padding:32px 40px;">
          ...
          <table cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
            <tr><td style="background:#a9793f;border-radius:5px;">
              <a href="${quoteUrl}" style="display:inline-block;padding:13px 28px;font-size:14px;font-weight:700;color:#221f1b;text-decoration:none;letter-spacing:0.04em;">Open My Quote →</a>
            </td></tr>
          </table>
